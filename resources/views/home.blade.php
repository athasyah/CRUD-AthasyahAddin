...
@section('content')
    <div class="container-fluid py-2">
            ...
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    ...
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm">total pengeluaran trip</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-2 ps-3">
                        <div class="d-flex justify-content-between">
                            <div>
                                <p class="text-sm mb-0 text-capitalize">Jumlah Trip</p>
                                {{-- <h4 class="mb-0">{{ $jumlahtrip }} Trip</h4> --}}
                            </div>
                            <div
                                class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm">berapa kali kamu bepergian</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                <div class="card">
                    <div class="card-header p-2 ps-3">
                        <div class="d-flex justify-content-between">
                            <div>
                                <p class="text-sm mb-0 text-capitalize">Jumlah Destinasi</p>
                                {{-- <h4 class="mb-0">{{ $jumlahdestinasi }} Destinasi</h4> --}}
                            </div>
                            <div
                                class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm">Jumlah Destinasi yang kamu kunjungi</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6">
                <div class="card">
                    <div class="card-header p-2 ps-3">
                        <div class="d-flex justify-content-between">
                            <div>
                                <p class="text-sm mb-0 text-capitalize">Jumlah rekan</p>
                                {{-- <h4 class="mb-0">{{ $jumlahrekan }} Orang</h4> --}}
                            </div>
                            <div
                                class="icon icon-md icon-shape bg-gradient-dark shadow-dark shadow text-center border-radius-lg">
                                <i class="material-symbols-rounded opacity-10">person</i>
                    ...
                    <hr class="dark horizontal my-0">
                    <div class="card-footer p-2 ps-3">
                        <p class="mb-0 text-sm">Jumlah keseluruhan teman perjalananmu</p>
                    </div>
                </div>
            </div>
        </div>
        <style>
            ...
            .img-shade-in {
                animation: shadeIn 0.8s ease-out forwards;
                opacity: 0;
                /* Supaya tidak muncul sebelum animasi */
            }
        </style>
        <center>
            {{-- <img src="{{ asset('assets/img/101421.jpg') }}" alt="Destination Image" style="width: 960px; margin-top: 40px; border-radius: 20px; padding-bottom: 9   0px;" --}}
                {{-- class="img-shade-in"> --}}
        </center>
        {{-- <div class="row">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="{{ asset('assets/img/small-logos/logo-xd.svg"') }} class="avatar
                                                        avatar-sm me-3" alt="xd">
                                                </div>
